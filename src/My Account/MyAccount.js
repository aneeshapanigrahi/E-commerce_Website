                    ...
                    <div className="col-12">
                        ...
                        <div style={contentStyle}>
                            ...
                            <Container style={{ boxShadow: '0 0 5px rgba(0,0,0,0.3)', padding: '20px 50px 20px 50px', marginLeft: '20px', marginRight: '20px', margin: 'auto', marginBottom: '20px' }} fluid>
                                <FormGroup>
                                    <FormLabel style={{ fontSize: '20px' }}>Personal Information</FormLabel><br />
                                    <FormLabel>First Name</FormLabel>
                                    <FormControl type='text' placeholder='First Name' style={{ maxWidth: '400px', margin: '0 0 20px 0' }}></FormControl>
                                    <FormLabel>Last Name</FormLabel>
                                    <FormControl type='text' placeholder='Last Name' style={{ maxWidth: '400px', margin: '0 0 20px 0' }}></FormControl>
                                </FormGroup>
                                <FormGroup>
                                    <FormLabel style={{ fontSize: '20px' }}>Email ID</FormLabel>
                                    <FormControl type='text' placeholder='Email ID' style={{ maxWidth: '400px', margin: '0 0 20px 0' }}></FormControl>
                                </FormGroup>
                                <FormGroup>
                                    <FormLabel style={{ fontSize: '20px' }}>Contact Number</FormLabel>
                                    <FormControl type='text' placeholder='Contact Number' style={{ maxWidth: '400px', margin: '0 0 20px 0' }}></FormControl>
                                </FormGroup>
                            </Container>
                        </div>
                    </div>
